...
CONF_SENSOR_DEFAULT = {
    "icon": "mdi:bike",
    CONF_SENSOR_1: CONF_SENSOR_DISTANCE,
    CONF_SENSOR_2: CONF_SENSOR_DURATION,
    CONF_SENSOR_3: CONF_SENSOR_SPEED,
    CONF_SENSOR_4: CONF_SENSOR_ELEVATION,
    CONF_SENSOR_5: CONF_SENSOR_TROPHIES,
}
